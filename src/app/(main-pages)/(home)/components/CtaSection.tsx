      ...
      <div className="container relative z-10 px-4 md:px-6 mx-auto">
        ...
        >
          <h2 className="text-3xl font-extrabold tracking-tight mt-10 mb-7 sm:text-5xl text-zinc-900 dark:text-white transition-colors">
            Ready to{" "}
            <span className="text-indigo-500  dark:text-indigo-400">ship?</span>
          </h2>

          <p className="text-zinc-500 dark:text-zinc-400 mb-10 text-lg leading-relaxed">
            Add beautifully crafted sections directly to your project via our
            registry. You own the raw code, you shape the experience.
          </p>

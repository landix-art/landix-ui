...
const features = [
  {
    ...
    description: "Access a comprehensive library of UI blocks built on top of the Shadcn architecture. Pure React components styled with Tailwind CSS.",
    icon: Blocks,
    highlightText: "Copy. Paste. Ship.",
    highlightDesc: "No npm install required for components. Just copy the code directly into your Next.js project and maintain complete ownership of your UI.",
  },
  {
    id: "feature-2",
    title: "Complete Landing Page Sections",
    description: "Everything you need to build high-converting landing pages. From Hero headers and Feature grids to Logo clouds and Footers.",
    icon: LayoutTemplate,
    highlightText: "Modular Architecture",
    highlightDesc: "Mix and match independent sections. Need a Pricing block or a Testimonial slider? Drop them in and they work flawlessly together.",
  },
  {
    id: "feature-3",
    title: "Native React & Tailwind CSS",
    description: "Written in strict TypeScript. Our blocks leverage modern Tailwind utility classes, perfectly aligned with Next.js App Router and Server Components.",
    icon: FileCode2,
    highlightText: "Zero Vendor Lock-in",
    highlightDesc: "You're not tied to any proprietary library. It's just clean, semantic code that naturally extends your existing tailwind configuration.",
  },
  {
    id: "feature-4",
    title: "Seamless Theme Integration",
    description: "Designed to inherit your global CSS variables instantly. Switch between dark and light modes without writing a single line of extra styling.",
    icon: Palette,
    highlightText: "Your Brand, Your Rules",
    highlightDesc: "Because it uses standard Shadcn design tokens, changing primary colors, border radiuses, and typography across all blocks takes seconds.",
  },
];
    ...
    <section className="w-full px-4 py-16 max-w-6xl mx-auto overflow-hidden">
      <div className="mb-12 md:mb-20 text-center max-w-2xl mx-auto px-4">
        ...
        <p className="text-muted-foreground text-sm md:text-base">
          Build stunning Next.js landing pages in minutes with our copy-and-paste Shadcn UI sections, Tailwind components, and modular layouts.
        </p>
      </div>
              ...
              return (
                ...
                >
                  ...
                  >
                    <feature.icon 
                      className={`w-4 h-4 md:w-5 md:h-5 transition-colors duration-500 ${
                        isActive ? "text-[#6361ff]" : "text-muted-foreground group-hover:text-foreground"
                      }`} 
                  ...
                  <div className="pt-0.5 md:pt-2 flex-1">
                    <h3 className={`text-base md:text-lg font-medium tracking-tight transition-colors duration-300 mb-1.5 ${
              ...
              <div className="relative z-10 w-full">
                ...
                >
                   {(() => {
                      ...
                      return <ActiveIcon className="w-6 h-6 md:w-8 md:h-8 text-[#6361ff]" strokeWidth={1.5} />;
                   })()}
                </motion.div>
